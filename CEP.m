function varargout = CEP(varargin)
...
% Last Modified by GUIDE v2.5 17-May-2022 01:12:47
...
set(handles.slider6,'min',200);
set(handles.slider6,'max',1000);
set(handles.slider6,'value',600);
set(handles.slider6,'SliderStep',[0.025,0.05]);
set(handles.edit4,'string',num2str(1));

set(handles.slider7,'min',2000);
set(handles.slider7,'max',3000);
set(handles.slider7,'value',2500);
set(handles.slider7,'SliderStep',[0.025,0.05]);
set(handles.edit5,'string',num2str(1));

set(handles.slider8,'min',3000);
set(handles.slider8,'max',4000);
set(handles.slider8,'value',3500);
set(handles.slider8,'SliderStep',[0.025,0.05]);
set(handles.edit6,'string',num2str(1));

set(handles.slider9,'min',4000);
set(handles.slider9,'max',20000);
set(handles.slider9,'value',10000);
...
global X;
[X,Fs]=audioread(filename);
y=y2*C(1)+y3*C(2)+y4*C(3)+y5*C(4)+y6*C(5)+y7*C(6);
